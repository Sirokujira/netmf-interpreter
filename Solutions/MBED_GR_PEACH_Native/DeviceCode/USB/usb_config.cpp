...
#define    PRODUCT_NAME_SIZE        8   /* "GR_PEACH" */
#define    DISPLAY_NAME_SIZE        8   /* "GR_PEACH" */
#define    FRIENDLY_NAME_SIZE       8   /* "GR_PEACH" */
// index for the strings
#define    MANUFACTURER_NAME_INDEX  1
#define    PRODUCT_NAME_INDEX       2
#define    SERIAL_NUMBER_INDEX      0
// device descriptor
#define    PRODUCT_ID               0x9EAC
#define    VENDOR_ID                0x1384
...
const struct USB_DYNAMIC_CONFIGURATION UsbDefaultConfiguration =
{
    // Device descriptor
    {
        ...
        0x0200,                             // Product version 1.00 (BCD)
