...
{
    { BlockRange::BLOCKTYPE_CODE        ,    0,  30 },       // ER_FLASH  (18000000-181FEFFF)
    { BlockRange::BLOCKTYPE_CONFIG      ,   31,  31 },       // ER_Config (181F0000-181FFFFF)
    { BlockRange::BLOCKTYPE_DEPLOYMENT  ,   32,  47 }        // DEPLOYMENT(18200000-1812FFFF)
};
