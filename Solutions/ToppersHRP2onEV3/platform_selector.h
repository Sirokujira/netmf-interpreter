...
//
#if defined(PLATFORM_ARM_ToppersHRP2onEV3)
#define HAL_SYSTEM_NAME                     "ToppersHRP2onEV3"
...
#endif // PLATFORM_ARM_TOPPERSHRP2ONEV3

#endif // _PLATFORM_TOPPERSHRP2ONEV3_SELECTOR_H_
