...
/*
 * Configuration constants (delete comment out if necessary)
 */
...
{
	return (char)UARTREG(p_siopcb, XUARTPS_FIFO_REG);
}
 ...
 */
Inline void
xuartps_putchar(SIOPCB *p_siopcb, char c)
{
