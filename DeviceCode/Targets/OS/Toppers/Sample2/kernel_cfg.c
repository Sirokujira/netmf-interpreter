...
static STK_T _kernel_stack_LOGTASK[COUNT_STK_T(LOGTASK_STACK_SIZE)] __attribute__((aligned(16)));
static STK_T _kernel_stack_TASK1[COUNT_STK_T(STACK_SIZE)] __attribute__((aligned(16)));
static STK_T _kernel_stack_TASK2[COUNT_STK_T(STACK_SIZE)] __attribute__((aligned(16)));
static STK_T _kernel_stack_TASK3[COUNT_STK_T(STACK_SIZE)] __attribute__((aligned(16)));
...
EXCHDR_ENTRY(CPUEXC1, 1, cpuexc_handler)
