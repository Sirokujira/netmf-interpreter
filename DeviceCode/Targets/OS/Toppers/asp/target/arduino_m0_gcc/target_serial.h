 ...
 *  SIOの割込みハンドラのベクタ番号
 */
#define INHNO_SIO		(16 + SERCOM5_IRQn)	/* 割込みハンドラ番号 */
#define INTNO_SIO		(16 + SERCOM5_IRQn)	/* 割込み番号 */
 ...
 * カーネル起動時のログ出力用の初期化
 */
extern void arduino_m0_init_uart(uint32_t siopid);

/*
 *  UARTからのポーリング出力
 */
void arduino_m0_putc(uint32_t siopid, char c);
