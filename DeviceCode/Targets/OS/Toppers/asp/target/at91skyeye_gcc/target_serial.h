 ...
 *  Copyright (C) 2007-20013 by Embedded and Real-Time Systems Laboratory
 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: target_serial.h 2741 2016-01-09 04:25:00Z ertl-honda $
 */
 ...
 *  SIOの割込みハンドラのベクタ番号
 */
#define INHNO_SIO        IRQ_USART0   /* 割込みハンドラ番号 */
#define INTNO_SIO        IRQ_USART0   /* 割込み番号 */
