...
const unsigned_t TOPPERS_cfg_valueof_iniatr_6 = ( unsigned_t )( TA_NULL ); /* #include "syssvc/banner.h" */

#line 10 "../asp/syssvc/banner.cfg"
const unsigned_t TOPPERS_cfg_static_api_7 = 7;
const unsigned_t TOPPERS_cfg_valueof_iniatr_7 = ( unsigned_t )( TA_NULL ); /* #include "target_syssvc.h" */
/* #include "target_serial.h" */
/* #include "windows_sigio.h" */

#line 12 "../asp/target/msvc/windows_sigio.cfg"
const unsigned_t TOPPERS_cfg_static_api_8 = 8;
const unsigned_t TOPPERS_cfg_valueof_intno_8 = ( unsigned_t )( INTNO_SIGIO ); const unsigned_t TOPPERS_cfg_valueof_intatr_8 = ( unsigned_t )( TA_ENAINT | INTATR_SIGIO ); const signed_t TOPPERS_cfg_valueof_intpri_8 = ( signed_t )( INTPRI_SIGIO ); 
...
const unsigned_t TOPPERS_cfg_valueof_isratr_11 = ( unsigned_t )( TA_NULL ); const unsigned_t TOPPERS_cfg_valueof_intno_11 = ( unsigned_t )( INTNO_SIGIO ); const signed_t TOPPERS_cfg_valueof_isrpri_11 = ( signed_t )( 1 ); /* #include "syssvc/serial.h" */
...
#line 10 "../asp/syssvc/logtask.cfg"
const unsigned_t TOPPERS_cfg_valueof_tskatr_21 = ( unsigned_t )( TA_ACT ); const signed_t TOPPERS_cfg_valueof_itskpri_21 = ( signed_t )( LOGTASK_PRIORITY ); const unsigned_t TOPPERS_cfg_valueof_stksz_21 = ( unsigned_t )( LOGTASK_STACK_SIZE ); 
#line 12 "../asp/syssvc/logtask.cfg"
const unsigned_t TOPPERS_cfg_static_api_22 = 22;
const unsigned_t TOPPERS_cfg_valueof_teratr_22 = ( unsigned_t )( TA_NULL ); /* #include "logtrace/trace_config.h" */

#line 15 "E:/netmf-interpreter3/DeviceCode/Targets/OS/Toppers/Sample1/main.cfg"
const unsigned_t TOPPERS_cfg_static_api_23 = 23;
const unsigned_t TOPPERS_cfg_valueof_iniatr_23 = ( unsigned_t )( TA_NULL ); 
#line 16 "E:/netmf-interpreter3/DeviceCode/Targets/OS/Toppers/Sample1/main.cfg"
const unsigned_t TOPPERS_cfg_static_api_24 = 24;
const unsigned_t TOPPERS_cfg_valueof_teratr_24 = ( unsigned_t )( TA_NULL ); /* #include "main.h" */

#line 19 "E:/netmf-interpreter3/DeviceCode/Targets/OS/Toppers/Sample1/main.cfg"
const unsigned_t TOPPERS_cfg_static_api_25 = 25;
#define TASK1	(<>)

#line 19 "E:/netmf-interpreter3/DeviceCode/Targets/OS/Toppers/Sample1/main.cfg"
const unsigned_t TOPPERS_cfg_valueof_tskatr_25 = ( unsigned_t )( TA_NULL ); const signed_t TOPPERS_cfg_valueof_itskpri_25 = ( signed_t )( MID_PRIORITY ); const unsigned_t TOPPERS_cfg_valueof_stksz_25 = ( unsigned_t )( STACK_SIZE ); 
#line 20 "E:/netmf-interpreter3/DeviceCode/Targets/OS/Toppers/Sample1/main.cfg"
const unsigned_t TOPPERS_cfg_static_api_26 = 26;
#define TASK2	(<>)

#line 20 "E:/netmf-interpreter3/DeviceCode/Targets/OS/Toppers/Sample1/main.cfg"
const unsigned_t TOPPERS_cfg_valueof_tskatr_26 = ( unsigned_t )( TA_NULL ); const signed_t TOPPERS_cfg_valueof_itskpri_26 = ( signed_t )( MID_PRIORITY ); const unsigned_t TOPPERS_cfg_valueof_stksz_26 = ( unsigned_t )( STACK_SIZE ); 
#line 21 "E:/netmf-interpreter3/DeviceCode/Targets/OS/Toppers/Sample1/main.cfg"
const unsigned_t TOPPERS_cfg_static_api_27 = 27;
#define TASK3	(<>)

#line 21 "E:/netmf-interpreter3/DeviceCode/Targets/OS/Toppers/Sample1/main.cfg"
const unsigned_t TOPPERS_cfg_valueof_tskatr_27 = ( unsigned_t )( TA_NULL ); const signed_t TOPPERS_cfg_valueof_itskpri_27 = ( signed_t )( MID_PRIORITY ); const unsigned_t TOPPERS_cfg_valueof_stksz_27 = ( unsigned_t )( STACK_SIZE ); 
#line 22 "E:/netmf-interpreter3/DeviceCode/Targets/OS/Toppers/Sample1/main.cfg"
const unsigned_t TOPPERS_cfg_static_api_28 = 28;
#define MAIN_TASK	(<>)

#line 22 "E:/netmf-interpreter3/DeviceCode/Targets/OS/Toppers/Sample1/main.cfg"
const unsigned_t TOPPERS_cfg_valueof_tskatr_28 = ( unsigned_t )( TA_ACT ); const signed_t TOPPERS_cfg_valueof_itskpri_28 = ( signed_t )( MAIN_PRIORITY ); const unsigned_t TOPPERS_cfg_valueof_stksz_28 = ( unsigned_t )( STACK_SIZE ); 
#line 23 "E:/netmf-interpreter3/DeviceCode/Targets/OS/Toppers/Sample1/main.cfg"
const unsigned_t TOPPERS_cfg_static_api_29 = 29;
const unsigned_t TOPPERS_cfg_valueof_texatr_29 = ( unsigned_t )( TA_NULL ); 
#line 24 "E:/netmf-interpreter3/DeviceCode/Targets/OS/Toppers/Sample1/main.cfg"
const unsigned_t TOPPERS_cfg_static_api_30 = 30;
const unsigned_t TOPPERS_cfg_valueof_texatr_30 = ( unsigned_t )( TA_NULL ); 
#line 25 "E:/netmf-interpreter3/DeviceCode/Targets/OS/Toppers/Sample1/main.cfg"
const unsigned_t TOPPERS_cfg_static_api_31 = 31;
const unsigned_t TOPPERS_cfg_valueof_texatr_31 = ( unsigned_t )( TA_NULL ); 
#line 26 "E:/netmf-interpreter3/DeviceCode/Targets/OS/Toppers/Sample1/main.cfg"
const unsigned_t TOPPERS_cfg_static_api_32 = 32;
#define CYCHDR1	(<>)

#line 26 "E:/netmf-interpreter3/DeviceCode/Targets/OS/Toppers/Sample1/main.cfg"
const unsigned_t TOPPERS_cfg_valueof_cycatr_32 = ( unsigned_t )( TA_NULL ); const unsigned_t TOPPERS_cfg_valueof_cyctim_32 = ( unsigned_t )( 2000 ); const unsigned_t TOPPERS_cfg_valueof_cycphs_32 = ( unsigned_t )( 0 ); 
#line 27 "E:/netmf-interpreter3/DeviceCode/Targets/OS/Toppers/Sample1/main.cfg"
const unsigned_t TOPPERS_cfg_static_api_33 = 33;
#define ALMHDR1	(<>)

#line 27 "E:/netmf-interpreter3/DeviceCode/Targets/OS/Toppers/Sample1/main.cfg"
const unsigned_t TOPPERS_cfg_valueof_almatr_33 = ( unsigned_t )( TA_NULL ); 
#ifdef CPUEXC1

#line 29 "E:/netmf-interpreter3/DeviceCode/Targets/OS/Toppers/Sample1/main.cfg"
const unsigned_t TOPPERS_cfg_static_api_34 = 34;
const unsigned_t TOPPERS_cfg_valueof_excno_34 = ( unsigned_t )( CPUEXC1 ); const unsigned_t TOPPERS_cfg_valueof_excatr_34 = ( unsigned_t )( TA_NULL ); 
#endif 
