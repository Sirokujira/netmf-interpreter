...
const struct name_to_cbp_tsColorSensor {
	...
	{ "BridgeColorSensor1", &nMruby_tsColorSensor_CB_tab[0] },
	{ "BridgeColorSensor2", &nMruby_tsColorSensor_CB_tab[1] },
	{ "BridgeColorSensor3", &nMruby_tsColorSensor_CB_tab[2] },
	{ "BridgeColorSensor4", &nMruby_tsColorSensor_CB_tab[3] },
	{ 0, 0 },
};
