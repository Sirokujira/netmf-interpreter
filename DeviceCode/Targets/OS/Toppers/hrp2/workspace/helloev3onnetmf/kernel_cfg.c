...
static STK_T _kernel_ustack_MAIN_TASK[COUNT_STK_T(4096)] __attribute__((section(".ustack_MAIN_TASK"),nocommon));
...
STK_T _kernel_ustack_TOPPERS_DUMMY2[COUNT_STK_T(4096)] __attribute__((section(".ustack_TOPPERS_DUMMY2"),nocommon));
