...
#   の責任を負わない．
#  
#   $Id: tecsgen.rb 2113 2014-10-12 19:01:39Z okuma-top $
#++
...
class TECSGEN
  ...
  module Makefile
    ...
    def self.set_default_config
      ...
      add_var( "TECSGEN_EXE", "tecsgen", "default TECS generator"  )
      add_var( "TIMESTAMP", "tecsgen.timestamp", "Time Stamp"  )
      ...
      add_var( "SRC_DIR", "$(BASE_DIR)/src", "default srource directory" )
