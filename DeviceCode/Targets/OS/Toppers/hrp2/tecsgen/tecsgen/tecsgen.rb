...
#   の責任を負わない．
#  
#   $Id: tecsgen.rb 2118 2014-10-15 14:12:00Z okuma-top $
#++
...
#Authors::   大山 博司
#Version::   
#Copyright:: Copyright (C) TOPPERS Project, 2008-2014. All rights reserved.
...
class TECSGEN
  ...
  def self.load_modules
    ...
    if ! $no_banner || $print_version
      STDERR << "tecsgen  version #{$version}  copyright(c) 2008-2015, TOPPERS project\n"
    end
    if $verbose then
    ...
    require_tecsgen_lib 'tecslib/core/location.rb'
