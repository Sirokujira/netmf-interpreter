 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: t_syslog.h 157 2008-07-01 10:20:20Z ertl-hiro $
 */
...
/*
 *  SysLogコンポーネントを使用するための宣言
 */
extern ER	tSysLog_eSysLog_write(uint_t prio, const SYSLOG *syslog) throw();

Inline ER
syslog_wri_log(uint_t prio, SYSLOG *syslog)
{
	return(tSysLog_eSysLog_write(prio, syslog));
}
