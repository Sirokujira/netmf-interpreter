...
void serial_tx_int_enable(serial_t *obj, int enable)
{
    if (enable != 0)
...
int serial_tx_int_state(serial_t *obj)
{
    return ((obj->uart->SCSCR & 0x0080) != 0);
}

void serial_rx_int_enable(serial_t *obj, int enable)
{
    if (enable != 0)
...
int serial_rx_int_state(serial_t *obj)
{
