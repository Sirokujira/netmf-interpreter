...
******************************************************************************/
__attribute__((section("SectionForFlashOperations"))) static int32_t set_mode (uint32_t ch_no, uint32_t dual, en_sf_req_t req, uint8_t data_width, uint8_t addr_mode);
__attribute__((section("SectionForFlashOperations"))) static int32_t read_status(uint8_t * status1, uint8_t * status2, uint32_t ch_no, uint32_t dual, uint8_t data_width);
__attribute__((section("SectionForFlashOperations"))) static int32_t read_config(uint8_t * config1, uint8_t * config2, uint32_t ch_no, uint32_t dual, uint8_t data_width);
__attribute__((section("SectionForFlashOperations"))) static int32_t read_bank(uint8_t * bank1, uint8_t * bank2, uint32_t ch_no, uint32_t dual, uint8_t data_width);
__attribute__((section("SectionForFlashOperations"))) static int32_t write_only_status(uint8_t status, uint32_t ch_no, uint32_t dual, uint8_t data_width);
__attribute__((section("SectionForFlashOperations"))) static int32_t write_status(uint8_t status, uint8_t config, uint32_t ch_no, uint32_t dual, uint8_t data_width);
__attribute__((section("SectionForFlashOperations"))) static int32_t write_bank(uint8_t bank, uint32_t ch_no, uint32_t dual, uint8_t data_width);
...
static int32_t read_status(uint8_t * status1, uint8_t * status2, uint32_t ch_no, uint32_t dual, uint8_t data_width)
{
    ...
    if( dual == SPIBSC_CMNCR_BSZ_SINGLE )
    {
        *status1 = (uint8_t)(g_spibsc_spimd_reg.smrdr[0]);          /* Data[7:0]  */
        *status2 = 0;
    }
    else
    {
        *status1 = (uint8_t)(g_spibsc_spimd_reg.smrdr[0] );       /* Data[7:0]   */
        *status2 = (uint8_t)(g_spibsc_spimd_reg.smrdr[0] >> 8);   /* Data[15:8]  */
    }
...
static int32_t read_config(uint8_t * config1, uint8_t * config2, uint32_t ch_no, uint32_t dual, uint8_t data_width)
{
    ...
    if( dual == SPIBSC_CMNCR_BSZ_SINGLE )
    {
        *config1 = (uint8_t)(g_spibsc_spimd_reg.smrdr[0]);   /* Data[7:0]  */
        *config2 = 0;
    }
    else
    {
        *config1 = (uint8_t)(g_spibsc_spimd_reg.smrdr[0]);        /* Data[7:0]   */
        *config2 = (uint8_t)(g_spibsc_spimd_reg.smrdr[0] >> 8);   /* Data[15:8]  */
    }
...
static int32_t read_bank(uint8_t * bank1, uint8_t * bank2, uint32_t ch_no, uint32_t dual, uint8_t data_width)
{
    ...
    if( dual == SPIBSC_CMNCR_BSZ_SINGLE )
    {
        *bank1 = (uint8_t)(g_spibsc_spimd_reg.smrdr[0]);   /* Data[7:0]  */
        *bank2 = 0;
    }
    else
    {
        *bank1 = (uint8_t)(g_spibsc_spimd_reg.smrdr[0]);        /* Data[7:0]  */
        *bank2 = (uint8_t)(g_spibsc_spimd_reg.smrdr[0] >> 8);   /* Data[15:8] */
    }
